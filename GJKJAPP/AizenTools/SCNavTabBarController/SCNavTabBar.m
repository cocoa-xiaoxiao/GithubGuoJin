...
{
    _line = [[UIView alloc] initWithFrame:CGRectMake(2.0f, NAV_TAB_BAR_HEIGHT - 3.0f, SCREEN_WIDTH / 3 - 10.0f, 3.0f)];
    if (self.lineColor == nil) {
        self.lineColor = [UIColor colorWithRed:28/255.0 green:160/255.0 blue:25/255.0 alpha:1];
    }
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        ...
        [button setTitleColor:[UIColor colorWithRed:28/255.0 green:160/255.0 blue:25/255.0 alpha:1] forState:UIControlStateNormal];
