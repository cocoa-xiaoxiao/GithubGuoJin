...
-(void)awakeFromNib
{
    ...
    NSString *leftLabelText = NSLocalizedString(@"是","Custom UISwitch ON label. If localized to empty string then I/O will be used");
    ...
    NSString *rightLabelText = NSLocalizedString(@"否","Custom UISwitch OFF label. If localized to empty string then I/O will be used");
