//
//  HaveCheckProposalListViewController.m
//  GJKJAPP
//
...
@interface HaveCheckProposalListViewController ()
{
    int _page;
}
...
@implementation HaveCheckProposalListViewController
...
-(void)getDataSourceFromHttpIsFooterRefresh:(BOOL)FooterRefresh
{
    ...
    [HttpService GetMyCheckListByUpdater:CurrAdminID andActivityID:batchID aboutStudentName:@"" and:10 and:_page success:^(id  _Nonnull responseObject) {
        if (FooterRefresh == YES) {
