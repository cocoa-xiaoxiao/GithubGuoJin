//
//  HaveCheckProListViewController.m
//  GJKJAPP
//
...
@interface HaveTaskBookListViewController ()
{
    int _page;
}
...
@implementation HaveTaskBookListViewController
...
-(NSArray *) detailLayout:(NSArray *)dataArr{
    ...
    for (int i = 0 ; i < dataArr.count; i++) {
        ...
        model.bname = [NSString checkNull:[dict objectForKey:@"ProjectName"]];
        NSRange rang = {0,10};
