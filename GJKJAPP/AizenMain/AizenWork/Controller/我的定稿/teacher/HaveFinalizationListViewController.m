//
//  HaveFinalizationListViewController.m
//  GJKJAPP
//
...
@interface HaveFinalizationListViewController ()
{
    int _page;
}
...
@implementation HaveFinalizationListViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self startLayout];
...
-(void)getDataSourceFromHttpIsFooterRefresh:(BOOL)FooterRefresh
{
    ...
    [HttpService GetMyProjectFinalizationCheckListFromUpdater:CurrAdminID andActivityID:batchID andStudentName:@"" and:10 and:_page success:^(id  _Nonnull responseObject) {
        if (FooterRefresh == YES) {
