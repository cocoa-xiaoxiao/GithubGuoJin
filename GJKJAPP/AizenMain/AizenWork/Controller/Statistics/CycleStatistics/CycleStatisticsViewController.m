//
//  CycleStatisticsViewController.m
//  GJKJAPP
//
...
#import "CycleStatisticsViewController.h"
#import "AizenHttp.h"
#import "AizenMD5.h"
...
@interface CycleStatisticsViewController ()<ChartViewDelegate>
...
@implementation CycleStatisticsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"周记统计";
...
-(void) handleChartsView:(UIView *)sender{
    ...
    [self setupPieChartView:_chartView getTitle:@"周记统计"];
...
- (void)setDataCount:(int)count range:(double)range{
    ...
    //    }
    [values addObject:[[PieChartDataEntry alloc] initWithValue:20 label:@"已审" icon: [UIImage imageNamed:@"icon"]]];
    
    [values addObject:[[PieChartDataEntry alloc] initWithValue:20 label:@"待审" icon: [UIImage imageNamed:@"icon"]]];
    
    [values addObject:[[PieChartDataEntry alloc] initWithValue:60 label:@"已交" icon: [UIImage imageNamed:@"icon"]]];
