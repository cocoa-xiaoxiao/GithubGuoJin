//
//  DutyStatisticsViewController.m
//  GJKJAPP
//
...
@interface DutyStatisticsViewController ()<UISearchBarDelegate>
...
@implementation DutyStatisticsViewController
...
-(void) listLayout{
    ...
    for(int i = 0;i<10;i++){
        StatisticsModelViewController *statistics = [[StatisticsModelViewController alloc]init_Value:i width:&width height:&height dataDic:[[NSMutableDictionary alloc]init] statusType:@"duty"];
