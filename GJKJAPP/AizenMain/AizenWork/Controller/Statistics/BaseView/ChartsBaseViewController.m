...
@interface ChartsBaseViewController ()<UITableViewDelegate, UITableViewDataSource>
...
//                                } range:NSMakeRange(centerText.length - 19, 19)];
    [centerText setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue-Light" size:18.f],NSParagraphStyleAttributeName: paragraphStyle} range:NSMakeRange(0, centerText.length)];
