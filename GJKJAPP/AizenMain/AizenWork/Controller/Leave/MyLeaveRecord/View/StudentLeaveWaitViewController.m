//
//  StudentLeaveWaitViewController.m
//  GJKJAPP
//
...
@interface StudentLeaveWaitViewController ()
...
@implementation StudentLeaveWaitViewController
...
-(void) startLayout{
    ...
    //NSString *FaceUrl = [_dataDic objectForKey:@""];123124
    ...
    _totalView = [[UIView alloc]initWithFrame:CGRectMake(0, _endView.frame.origin.y + _endView.frame.size.height, _detailView.frame.size.width, _detailView.frame.size.height * 0)];
