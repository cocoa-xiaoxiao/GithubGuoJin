//
//  StudentLeavePassViewController.m
//  GJKJAPP
//
...
@interface StudentLeavePassViewController ()
...
@implementation StudentLeavePassViewController
...
-(void) startLayout{
    ...
    _statusImgView.image = [UIImage imageNamed:@"gj_leavepass"];
    [self animationShootOut:_statusImgView];
    ...
    _deparmentView = [[UIView alloc]initWithFrame:CGRectMake(0, _numView.frame.size.height + _numView.frame.origin.y, _detailView.frame.size.width, _detailView.frame.size.height * 0.0)];
    ...
    _totalView = [[UIView alloc]initWithFrame:CGRectMake(0, _endView.frame.origin.y + _endView.frame.size.height, _detailView.frame.size.width, _detailView.frame.size.height * 0.0)];
    ...
    _historyView = [[UIView alloc]initWithFrame:CGRectMake(0, _reasonView.frame.origin.y + _reasonView.frame.size.height, _detailView.frame.size.width, _detailView.frame.size.height * 0.1)];
