...
@interface NewWSTaskViewController ()
{
    int _page;
}
...
@implementation NewWSTaskViewController
...
-(void)getDataSourceFromHttpIsFooterRefresh:(BOOL)FooterRefresh
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@/ApiActivityTaskInfo/GetReporterTaskList?AdminID=%@&ActivityID=%@&TaskTitle=%@&rows=1000&page=1",kCacheHttpRoot,CurrAdminID,batchID,@""];
    NSLog(@"%@",url);
