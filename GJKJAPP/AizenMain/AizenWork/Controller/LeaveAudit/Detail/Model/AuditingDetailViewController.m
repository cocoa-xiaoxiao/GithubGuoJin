//
//  AuditingDetailViewController.m
//  GJKJAPP
//
...
@interface AuditingDetailViewController (){
    int *number;
...
@implementation AuditingDetailViewController
...
-(void) startLayout{
    ...
    cancelBtn.backgroundColor = [UIColor colorWithRed:7/255.0 green:177/255.0 blue:255/255.0 alpha:1];
