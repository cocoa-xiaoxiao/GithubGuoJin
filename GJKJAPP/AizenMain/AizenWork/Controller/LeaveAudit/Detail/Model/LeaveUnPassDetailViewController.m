//
//  LeaveUnPassDetailViewController.m
//  GJKJAPP
//
...
@interface LeaveUnPassDetailViewController (){
    int *number;
...
@implementation LeaveUnPassDetailViewController
...
-(void) startLayout{
    ...
    [cancelBtn setTitle:@"未通过" forState:UIControlStateNormal];
