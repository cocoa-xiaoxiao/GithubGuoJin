//
//  NotMyReviewListViewController.m
//  GJKJAPP
//
...
@interface NotMyReviewListViewController ()
{
    int _page;
}
...
@implementation NotMyReviewListViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self startLayout];
...
-(void)getDataSourceFromHttpIsFooterRefresh:(BOOL)FooterRefresh
{
    ...
    [HttpService GetMyReviewList:CurrAdminID with:batchID with:@"" with:@"" with:1 and:10 and:_page success:^(id  _Nonnull responseObject) {
        if (FooterRefresh == YES) {
