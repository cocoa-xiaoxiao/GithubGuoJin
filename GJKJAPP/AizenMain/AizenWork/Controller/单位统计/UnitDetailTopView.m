...
@end
@implementation UnitDetailTopView
...
-(void)initData
{
    self.percentage = self.detailModel.unit_sxl * 0.01;
    ...
    lab1.text = [NSString stringWithFormat:@"在岗实习:%d",self.detailModel.unit_zg];
    ...
    lab2.text = [NSString stringWithFormat:@"学生总数:%d",self.detailModel.renshu];
    ...
    lab3.text = [NSString stringWithFormat:@"基地实习:%d",self.detailModel.unit_jd];
