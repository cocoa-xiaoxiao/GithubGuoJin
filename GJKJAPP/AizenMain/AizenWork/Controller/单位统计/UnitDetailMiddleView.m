...
@interface UnitDetailMiddleView()
{
...
@end
@implementation UnitDetailMiddleView
...
-(void)addLines1With:(UIView *)view{
    ...
    CGFloat marginWidth = view.bounds.size.width/3;
    Xmargin = marginWidth;
