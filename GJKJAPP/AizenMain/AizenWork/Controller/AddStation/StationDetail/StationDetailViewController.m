...
@interface StationDetailViewController ()<UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating, UISearchBarDelegate>
...
-(void)searchBarSearchButtonClicked:(UISearchBar *)searchBar{
    ...
    NSDictionary *setDic = [[NSDictionary alloc]initWithObjectsAndKeys:inputStr,@"PositionName",@"0",@"ID", nil];
    _searchController.active = NO;
