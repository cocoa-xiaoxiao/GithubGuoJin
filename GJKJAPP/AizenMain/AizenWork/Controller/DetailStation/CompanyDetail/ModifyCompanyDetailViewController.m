...
@interface ModifyCompanyDetailViewController ()<UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating, UISearchBarDelegate>
...
@implementation ModifyCompanyDetailViewController
...
-(void) handleData:(NSArray *)dataArr{
    ...
    for(int i = 0;i<[dataArr count];i++){
        ...
        [setDic setObject:@"company" forKey:@"Type"];
...
-(void)searchBarSearchButtonClicked:(UISearchBar *)searchBar{
    ...
    NSDictionary *setDic = [[NSDictionary alloc]initWithObjectsAndKeys:inputStr,@"EnterpriseName",@"0",@"ID", @"company",@"Type",nil];
    _searchController.active = NO;
    
    ModifyStationViewController *modifyStation = [self.navigationController.viewControllers objectAtIndex:self.navigationController.viewControllers.count-2];
    modifyStation.getReturnDic = nil;
    modifyStation.getReturnDic = setDic;
    [self.navigationController popToViewController:modifyStation animated:YES];
}
